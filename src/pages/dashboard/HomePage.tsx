    ...
    <div>
      <div className="grid sm:grid-cols-3 md:grid-cols-5 gap-6 text-center">
          ...
          {(value) => {
            return (
              <>
                {isManager && (
                  <Link
                    to="/dashboard/users#teachers"
                    className="bg-brand text-white bg-opacity-40 shadow flex items-center justify-center flex-col space-y-4 p-6 px-8 rounded-2xl"
                  >
                    <svg
                ...
                {isManager && (
                  <Link
                    to="/dashboard/users#assistants"
                    className="bg-primary text-white shadow flex items-center justify-center flex-col space-y-4 p-6 px-8 rounded-2xl"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="icon icon-tabler icon-tabler-users"
                ...
                {role === Role.Admin && (
                  <Link
                    to="/dashboard/users#po-managers"
                    className="bg-blue-300 text-white shadow flex items-center justify-center flex-col space-y-4 p-6 px-8 rounded-2xl"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="icon icon-tabler icon-tabler-users"
        ...
        <Link
          ...
          className="bg-brand text-white shadow flex items-center justify-center flex-col space-y-4 p-6 px-8 rounded-2xl"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <Link
          ...
          className="bg-gray-400 text-white shadow flex items-center justify-center flex-col space-y-4 p-6 px-8 rounded-2xl"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="25"
      ...
      <TeacherClassesProvider>
        {(value) => {
          ...
          const todaysClasses = value.trClasses.filter((el) =>
            Utils.isToday(el.date)
          );
              ...
              <div>
                <div>
                  <div className="grid md:grid-cols-2 gap-4">
                    {todaysClasses.slice(0, 10).map((trClass, index) => {
                      return (
                        <div
                        ...
                        >
                          ...
                          <div className="flex-grow text-xs">
                            <p className="font-semibold text-sm">
                              <Link to={`/dashboard/time-table/${trClass.id}`}>
                                {trClass.name}
                              </Link>
                            </p>
                            <p>
                            ...
                            <p>
                              <SingleUserContextProvider id={trClass.teacherId}>
                                {(value) => {
                                  if (value.isLoading) {
